...
class AlertCodes(IntEnum):
    MEDICAL_ALERT_OFFSET = 0
    SYSTEM_ALERT_OFFSET = 100
    OK = 0
    PRESSURE_LOW = MEDICAL_ALERT_OFFSET + 1
    PRESSURE_HIGH = MEDICAL_ALERT_OFFSET + 2
    VOLUME_LOW = MEDICAL_ALERT_OFFSET + 3
    VOLUME_HIGH = MEDICAL_ALERT_OFFSET + 4
    PEEP_TOO_HIGH = MEDICAL_ALERT_OFFSET + 5
    PEEP_TOO_LOW = MEDICAL_ALERT_OFFSET + 6
    BPM_LOW = MEDICAL_ALERT_OFFSET + 7
    BPM_HIGH = MEDICAL_ALERT_OFFSET + 8
    NO_BREATH = MEDICAL_ALERT_OFFSET + 9
    NO_CONFIGURATION_FILE = SYSTEM_ALERT_OFFSET + 1
    FLOW_SENSOR_ERROR = SYSTEM_ALERT_OFFSET + 2
    PRESSURE_SENSOR_ERROR = SYSTEM_ALERT_OFFSET + 3
    OXYGEN_SENSOR_ERROR = SYSTEM_ALERT_OFFSET + 4
    OXYGEN_LOW = SYSTEM_ALERT_OFFSET + 5
    OXYGEN_HIGH = SYSTEM_ALERT_OFFSET + 6
    NO_BATTERY = SYSTEM_ALERT_OFFSET + 7
