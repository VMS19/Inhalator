...
class DriverFactory(object):
    ...
    @classmethod
    def generate_mock_oxygen_a2d_data(cls):
        samples = sinus(
            cls.MOCK_SAMPLE_RATE_HZ,
            cls.MOCK_A2D_AMPLITUDE,
            cls.MOCK_BPM / 60)
        samples = truncate(
    ...
    @classmethod
    def get_mock_oxygen_a2d_driver(cls):
        from drivers.mocks.sensor import MockSensor
        return MockSensor(cls.generate_mock_oxygen_a2d_data())
...
MOCK_DRIVERS_DICT = {"pressure": DriverFactory.get_mock_pressure_driver,
                     ...
                     "oxygen_a2d": DriverFactory.get_mock_oxygen_a2d_driver}
